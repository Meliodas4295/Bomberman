...
// to destination
std::vector<pair<int, int>> PathFinding::tracePath(cell cellDetails[][COL], Pair dest)
{
    printf("\nThe Path is ");
    int row = dest.first;
    int col = dest.second;
...
std::vector<pair<int, int>> PathFinding::aStarSearch(int grid[][COL], Pair src, Pair dest)
{
    std::vector<pair<int, int>> v;
